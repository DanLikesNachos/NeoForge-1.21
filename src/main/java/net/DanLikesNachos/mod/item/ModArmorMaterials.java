...
public class ModArmorMaterials {
    ...
    public static final Holder<ArmorMaterial> MITHRIL_ARMOR_MATERIAL = register("mithril",
            ...
            }), 18, 3f, 0.2f, () -> ModItems.MITHRIL_INGOT.get());
    ...
    public static final Holder<ArmorMaterial> ADAMANTITE_ARMOR_MATERIAL = register("adamantite",
            Util.make(new EnumMap<>(ArmorItem.Type.class), attribute -> {
                ...
                attribute.put(ArmorItem.Type.HELMET, 5);
                attribute.put(ArmorItem.Type.BODY, 11);
            }), 18, 3f, 0.2f, () -> ModItems.ADAMANTITE_INGOT.get());


    private static Holder<ArmorMaterial> register(String name, EnumMap<ArmorItem.Type, Integer> typeProtection,
                                                  int enchantability, float toughness, float knockbackResistance,
                                                  Supplier<Item> ingredientItem) {
        ResourceLocation location = ResourceLocation.fromNamespaceAndPath(Mod.MOD_ID, name);
