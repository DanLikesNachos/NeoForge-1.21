package net.DanLikesNachos.mod.item.custom;

import com.google.common.collect.ImmutableMap;
import net.DanLikesNachos.mod.item.ModArmorMaterials;
    ...
    private static final Map<Holder<ArmorMaterial>, List<MobEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<Holder<ArmorMaterial>, List<MobEffectInstance>>())
                    .put(ModArmorMaterials.MITHRIL_ARMOR_MATERIAL,
                            List.of(new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 20, 2, false, false),
                            new MobEffectInstance(MobEffects.JUMP, 20, 1, false, false)))
                    .put(ModArmorMaterials.ADAMANTITE_ARMOR_MATERIAL,
                            List.of(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 20, 0, false, false),
                                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 20, 0, false, false)))
                    .build();
