...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        handheldItem(ModItems.MITHRIL_HAMMER);
        ...
        handheldItem(ModItems.ADAMANTITE_HOE);

        handheldItem(ModItems.ADAMANTITE_HAMMER);
    ...
    private void trimmedArmorItem(DeferredItem<ArmorItem> itemDeferredItem) {
        final String MOD_ID = Mod.MOD_ID; // Change this to your mod id
